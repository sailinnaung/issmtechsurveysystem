...
<html>
    ...
    <body>
        ...
        <s:form namespace="/questionnaire" id="questionnaire_new_form" action="createQuestionniare_survey" method="post">	
	<div id="questionnaire_new_details" align="center">
               <s:if test="currentSurvey.code==null">
	...
	<div id="questionnaire_new_button" align="center">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
		  <tr>                      
                      <td  align="center"><s:submit name="submitBtn" label="Create"/></td>                      
